...
{
	public class DisconnectWalletExample : MonoBehaviour
	{
		[Serializable]
		...
		{
			WalletConnect.Instance.autoSaveAndResume = true;
			WalletConnect.Instance.createNewSessionOnSessionDisconnect = true;
			WalletConnect.Instance.Session.Disconnect();
		}

		public async void ConnectReestablish()
		{
			await WalletConnect.Instance.Session.Connect();
		}
